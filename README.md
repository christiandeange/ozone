![Maven Central](https://img.shields.io/maven-central/v/sh.christian.ozone/bluesky?versionPrefix=0.2.1) ![CI](https://github.com/christiandeange/ozone/actions/workflows/ci.yml/badge.svg)
...
dependencies {
  api("sh.christian.ozone:bluesky:0.2.1")
}
```
...
plugins {
  id("sh.christian.ozone.generator") version "0.2.1"
}
