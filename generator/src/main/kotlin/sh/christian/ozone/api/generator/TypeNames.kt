...
object TypeNames {
  ...
  val PermissionResource by classOfPackage("sh.christian.ozone.api.model.permissions")
  val PermissionSet by classOfPackage("sh.christian.ozone.api.model.permissions")
  val RepoPermission by classOfPackage("sh.christian.ozone.api.model.permissions")
  val Result by classOfPackage("kotlin")
  val RpcPermission by classOfPackage("sh.christian.ozone.api.model.permissions")
